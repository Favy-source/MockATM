...
def create(user_account_number, first_name, middle_name, last_name, email, password):

    # create a file
    # name of the file would be account_number.txt
    # include the user details to the file
    # return true
    # if file fails to save, then delete created file

    user_data = first_name + ","+ middle_name +"," + last_name + "," + email + "," + password + "," + str(0)
...
def update(user_account_number):
    ...
    # edit and update the content of the file
    # save the file
    # return true
